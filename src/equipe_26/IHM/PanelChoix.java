...
public class PanelChoix extends JPanel implements ActionListener
{
	...
	private String []   avatars  = new String[] {"Avatar1", "Avatar2"  , "Avatar3" , "Avatar4", "equipe", "Avatar5" , "Avatar6", "Avatar7", "Avatar8"  };
	...
	{
		for(int cpt=0; cpt<this.boutons.length; cpt++)
			this.boutons[cpt].setIcon(new ImageIcon("./ressource/couleur/" + this.couleurs[cpt] + ".png"));
		this.bAvatar = false;
		Controleur.getInstance().desactivationButton();
	}
